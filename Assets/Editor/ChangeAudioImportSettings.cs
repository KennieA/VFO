...
public class ChangeAudioImportSettings : ScriptableObject {
    ...
    static void SelectedToggleCompressionSettings(AudioImporterFormat newFormat) {
        ...
        foreach (AudioClip audioclip in audioclips) {
            ...
            //audioImporter.format = newFormat; //REFACTOR MC 21-06-2016 - Outcommented due to deprecated function in Unity v.5.x
    ...
    static void SelectedSetCompressionBitrate(float newCompressionBitrate) {
        ...
        foreach (AudioClip audioclip in audioclips) {
            ...
            //audioImporter.compressionBitrate = (int)newCompressionBitrate; //REFACTOR MC 21-06-2016 - Outcommented due to deprecated function in Unity v.5.x
    ...
    static void SelectedToggleDecompressOnLoadSettings(AudioClipLoadType enabled) {
        ...
        foreach (AudioClip audioclip in audioclips) {
            ...
            //audioImporter.loadType = enabled; //REFACTOR MC 21-06-2016 - Outcommented due to deprecated function in Unity v.5.x
