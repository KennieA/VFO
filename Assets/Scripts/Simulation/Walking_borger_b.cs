...
public class Walking_borger_b : MonoBehaviour 
{	
    ...
    {
        // Exercise States
        States.Instance.InitExerciseState(new string[] { "hoover_upper_torso", "hoover_hips" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_walk_b_state_place_hand"), 3.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_walk_b_state_walk_forward"), 5.0f);

        // Help text
        Help.Instance.AddHelpText(new string[] { "start" }, "sim_walk_b_help_place_hand");
        Help.Instance.AddHelpText(new string[] { "hoover_hips", "hoover_upper_torso" }, "sim_walk_b_help_walk_forward");

        // Dialog
        Talk.Instance.AddTalkDialog("hoover_head", "sim_walk_b_talk_walk_forward");
        ...
        AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_0" }, "Walking1", "200_30", 0.0f, false, 20);

        // Animations Borger
        AnimateBorger.Instance.SetIdle("200_10");
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_0" }, "Walking", "200_30", 0.0f, false, 10);

        // Animate Walker
        AnimateWalker2.Instance.AddAnimation(new string[] { "Talk_0_0" }, "Walking", "200_30", 0.0f, false, 10);
    }
