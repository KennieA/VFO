...
public class Stand_up_borger_c : MonoBehaviour 
{	
    ...
    {
        // Exercise States
        States.Instance.InitExerciseState(new string[] { "Talk_1_0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_stand_c_state_assisthand"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_stand_c_state_forward"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "HUD_Walker2(Clone)#1" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_stand_c_state_walker"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_1" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_stand_c_state_feet"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_2" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_stand_c_state_hand"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_3" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_stand_c_state_lean"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_4" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_stand_c_state_stand"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "BedHeightUp" }, States.CheckCon.NotCritical, "", 5.0f);

        // Help text
        Help.Instance.AddHelpText(new string[] { "start" },  "sim_stand_c_help_toolbox");
        Help.Instance.AddHelpText(new string[] { "ToolboxDone" },  "sim_stand_c_help_assisthand");
        Help.Instance.AddHelpText(new string[] { "Talk_1_0" },  "sim_stand_c_help_forward");
        Help.Instance.AddHelpText(new string[] { "Talk_0_0" },  "sim_stand_c_help_walker");
        Help.Instance.AddHelpText(new string[] { "HUD_Walker2(Clone)#1" }, "sim_stand_c_help_feet");
        Help.Instance.AddHelpText(new string[] { "Talk_0_1" },  "sim_stand_c_help_hand");
        Help.Instance.AddHelpText(new string[] { "Talk_0_2" },  "sim_stand_c_help_lean");
        Help.Instance.AddHelpText(new string[] { "Talk_0_3" },  "sim_stand_c_help_ready");
        Help.Instance.AddHelpText(new string[] { "Talk_0_4" },  "sim_stand_c_help_stand");

        // Dialog
        int pos1 = Talk.Instance.AddTalkDialog("hoover_head", "sim_stand_c_talk_forward");
        Talk.Instance.AddTalkDialog(pos1, "sim_stand_c_talk_feet");
        Talk.Instance.AddTalkDialog(pos1, "sim_stand_c_talk_hand");
        Talk.Instance.AddTalkDialog(pos1, "sim_stand_c_talk_lean");
        Talk.Instance.AddTalkDialog(pos1, "sim_stand_c_talk_stand");

        int pos2 = Talk.Instance.AddTalkDialog("clickedHelper", "sim_stand_c_talk_assisthand");
        
        // Animations Female Helper
        AnimateFemale.Instance.SetIdle("idle_100f");

        // Animations Male Helper
        AnimateMale.Instance.SetIdle("180_10");
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_1_0" }, "PlaceHand", "180_20", 0.0f, false, 10);
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_0_0" }, "MoveForward", "180_30", 0.0f, false, 20);
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_0_3" }, "LeanForward", "180_40", 0.0f, false, 30);
        AnimateMale.Instance.AddAnimation(new string[] { "BedHeightUp" }, "StandUp", "180_50", 0.0f, false, 40);
        ...
        AnimateBed3.Instance.AddAnimation(new string[] { "BedHeightUp" }, "middle_to_low", 0.0f, 2.5f);
