...
public class Lifting_from_bed_to_chair_rooflift : MonoBehaviour 
{	
    ...
    private void defineExercise()
    {
        ...
        AnimateFemale.Instance.AddAnimation(new string[] { "clickedSling1" }, "AttachStraps", "1110_50", 0.0f, false, 10);
        AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_1" }, "MoveLift", "1110_90", 1.0f, false, 20, 1.0f, 0.0f);
        AnimateFemale.Instance.AddAnimation(new string[] { "RoofLiftDown2" }, "RoofLiftDownChair", "1110_100", 0.0f, false, 30);
        AnimateFemale.Instance.AddAnimation(new string[] { "clickedSling2" }, "DetachStraps", "1110_110", 1.6f, false, 40);

        // Animate Male Helper
        AnimateMale.Instance.SetIdle("500_10");
        AnimateMale.Instance.AddAnimation(new string[] { "clickedSling1" }, "AttachStraps", "1110_50", 0.0f, false, 10);
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_0_1" }, "MoveLift", "1110_90", 1.0f, false, 20, 1.0f, 0.0f);
        AnimateMale.Instance.AddAnimation(new string[] { "clickedSling2" }, "DetachStraps", "1110_110", 0.0f, false, 30);
        ...
        AnimateBorger.Instance.AddAnimation(new string[] { "RoofLiftDown2" }, "RoofLiftDownChair", "1110_100", 0.0f, false, 50, -1.0f, 2.0f);
        ...
        AnimateSling2.Instance.AddAnimation(new string[] { "clickedSling1" }, "AttachStraps", "1110_50", 0.0f, false, 10);
        ...
        AnimateSling2.Instance.AddAnimation(new string[] { "clickedSling2" }, "DetachStrops", "1110_110", 1.6f, false, 60);
