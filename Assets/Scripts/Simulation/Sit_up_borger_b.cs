...
public class Sit_up_borger_b : MonoBehaviour 
{	
    ...
    private void defineExercise()
    {
        ...
        States.Instance.InitExerciseState(new string[] { "BedHeadUp" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_sit_b_state_bedhead"), 7.0f);

        // Help text
        Help.Instance.AddHelpText(new string[] { "start" }, "sim_sit_b_help_toolbox");
        ...
        Help.Instance.AddHelpText(new string[] { "Talk_0_1" }, "sim_sit_b_help_ready");
