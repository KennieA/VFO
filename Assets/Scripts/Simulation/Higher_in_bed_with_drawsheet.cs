...
public class Higher_in_bed_with_drawsheet : MonoBehaviour 
{	
    ...
    {
        // Exercise States
        States.Instance.InitExerciseState(new string[] { "Talk_0_0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_high_bed_draw_state_7"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "HUD_AntiSlideMat2(Clone)#2" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_high_bed_draw_state_8"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_1" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_high_bed_draw_state_1"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "HUD_SlideMat2(Clone)#1" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_high_bed_draw_state_2"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_2" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_high_bed_draw_state_3"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "HUD_SlideMat2(Clone)#0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_high_bed_draw_state_4"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_3" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_high_bed_draw_state_5"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_4" }, States.CheckCon.NotCritical, "", 6.0f);
        
        // Help text
        Help.Instance.AddHelpText(new string[] { "start" }, "sim_high_bed_draw_help_0");
        Help.Instance.AddHelpText(new string[] { "ToolboxDone" }, "sim_high_bed_draw_help_8");
        Help.Instance.AddHelpText(new string[] { "Talk_0_0" }, "sim_high_bed_draw_help_9");
        Help.Instance.AddHelpText(new string[] { "HUD_AntiSlideMat2(Clone)#2" }, "sim_high_bed_draw_help_2");
        Help.Instance.AddHelpText(new string[] { "Talk_0_1" }, "sim_high_bed_draw_help_3");
        Help.Instance.AddHelpText(new string[] { "HUD_SlideMat2(Clone)#1" }, "sim_high_bed_draw_help_4");
        Help.Instance.AddHelpText(new string[] { "Talk_0_2" }, "sim_high_bed_draw_help_5");
        Help.Instance.AddHelpText(new string[] { "HUD_SlideMat2(Clone)#0" }, "sim_high_bed_draw_help_6");
        Help.Instance.AddHelpText(new string[] { "Talk_0_3" }, "sim_high_bed_draw_help_10");

        // Dialog
        int pos1 = Talk.Instance.AddTalkDialog("hoover_head", "sim_high_bed_draw_talk_4");
        Talk.Instance.AddTalkDialog(pos1, "sim_high_bed_draw_talk_1");
        Talk.Instance.AddTalkDialog("HUD_SlideMat2(Clone)#1", pos1, "sim_high_bed_draw_talk_2");
        Talk.Instance.AddTalkDialog("HUD_SlideMat2(Clone)#0", pos1, "sim_high_bed_draw_talk_3");
        Talk.Instance.AddTalkDialog(pos1, "sim_high_bed_draw_talk_5");
        ...
        AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_1" }, "TurnRight", "500_30", 0.0f, false, 20);
        AnimateFemale.Instance.AddAnimation(new string[] { "HUD_SlideMat2(Clone)#1" }, "PlaceSlideMat1", "500_40", 0.0f, false, 30);
        AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_2" }, "TurnLeft", "500_50", 4.5f, false, 40);
        AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_3" }, "TurnBack", "500_65", 0.0f, false, 60);
        AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_4" }, "PullBedSheet", "500_100", 0.0f, false, 80);
        ...
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_1" }, "TurnRight", "500_30", 0.0f, false, 20);
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_2" }, "TurnLeft", "500_50", 0.0f, false, 40);
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_3" }, "TurnBack", "500_65", 0.0f, false, 60);
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_4" }, "PullBedSheet", "500_100", 3.6f, false, 80);      
        ...
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_0_1" }, "TurnRight", "500_30", 0.0f, false, 20);
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_0_2" }, "TurnLeft", "500_50", 0.0f, false, 40);
        AnimateMale.Instance.AddAnimation(new string[] { "HUD_SlideMat2(Clone)#0" }, "PlaceSlideMat2", "500_60", 0.0f, false, 50);
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_0_4" }, "PullBedSheet", "500_100", 0.0f, false, 80);

        // Animate Drawsheet
        AnimateDrawSheet2.Instance.SetIdle("500_10");
        AnimateDrawSheet2.Instance.AddAnimation(new string[] { "Talk_0_1" }, "TurnHalfRight", "500_30", 0.0f, false, 20);
        AnimateDrawSheet2.Instance.AddAnimation(new string[] { "Talk_0_2" }, "TurnHalfLeft", "500_50", 0.0f, false, 30);
        AnimateDrawSheet2.Instance.AddAnimation(new string[] { "Talk_0_3" }, "TurnBackOnBack", "500_65", 0.0f, false, 40);
        AnimateDrawSheet2.Instance.AddAnimation(new string[] { "Talk_0_4" }, "PullDrawSheet", "500_100", 3.6f, false, 70);

        // Animate Slidemat
        AnimateSlideMat2.Instance.SetIdle("500_10");
        AnimateSlideMat2.Instance.AddAnimation(new string[] { "HUD_SlideMat2(Clone)#1" }, "PlaceSlideMat1", "500_40", 0.0f, false, 10, 0.0f, 0.1f);
        AnimateSlideMat2.Instance.AddResetState(new string[] { "HUD_SlideMat2(Clone)#1" });

        AnimateSlideMat21.Instance.SetIdle("500_10b");
        AnimateSlideMat21.Instance.AddAnimation(new string[] { "HUD_SlideMat2(Clone)#0" }, "PlaceSlideMat2", "500_60b", 0.0f, false, 60, 0.0f, -1.0f, 0.0f);
        AnimateSlideMat21.Instance.AddResetState(new string[] { "HUD_SlideMat2(Clone)#0" });

        // Anmimate Pillow
        AnimatePillow.Instance.SetIdle("50_10");
        AnimatePillow.Instance.AddAnimation(new string[] { "Talk_0_4" }, "PullDrawSheet", "500_100", 3.6f, false, 10);

        // AnimateAntiSlidemat
        AnimateAntiSlideMat.Instance.SetIdle("60_10");
        AnimateAntiSlideMat.Instance.AddAnimation(new string[] { "HUD_AntiSlideMat2(Clone)#2" }, "PlaceAntiSlideMat", "60_20", 0.0f, false, 10, -1.0f, 0.0f);
