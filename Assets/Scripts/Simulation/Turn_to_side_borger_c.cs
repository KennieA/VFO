...
public class Turn_to_side_borger_c : MonoBehaviour 
{	
    ...
    {
        // Exercise States
        States.Instance.InitExerciseState(new string[] { "Talk_0_0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_turn_c_state_0"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_1" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_turn_c_state_1"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "HUD_SlideMat2(Clone)#1" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_turn_c_state_2"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_2" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_turn_c_state_3"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "HUD_SlideMat2(Clone)#0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_turn_c_state_4"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_3" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_turn_c_state_5"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_4" }, States.CheckCon.NotCritical, Text.Instance.GetString(""), 10.0f);

        // Help text
        Help.Instance.AddHelpText(new string[] { "start" }, "sim_turn_c_help_0");
        Help.Instance.AddHelpText(new string[] { "ToolboxDone" }, "sim_turn_c_help_1");
        Help.Instance.AddHelpText(new string[] { "Talk_0_0" }, "sim_turn_c_help_2");
        Help.Instance.AddHelpText(new string[] { "Talk_0_1" }, "sim_turn_c_help_3");
        Help.Instance.AddHelpText(new string[] { "HUD_SlideMat2(Clone)#1" }, "sim_turn_c_help_4");
        Help.Instance.AddHelpText(new string[] { "Talk_0_2" }, "sim_turn_c_help_5");
        Help.Instance.AddHelpText(new string[] { "HUD_SlideMat2(Clone)#0" }, "sim_turn_c_help_6");
        Help.Instance.AddHelpText(new string[] { "Talk_0_3" }, "sim_turn_c_help_7");

        // Dialog
        int pos1 = Talk.Instance.AddTalkDialog("hoover_head", "sim_turn_c_talk_0");
        Talk.Instance.AddTalkDialog(pos1, "sim_turn_c_talk_1");
        Talk.Instance.AddTalkDialog("HUD_SlideMat2(Clone)#1", pos1, "sim_turn_c_talk_2");
        Talk.Instance.AddTalkDialog("HUD_SlideMat2(Clone)#1", pos1, "sim_turn_c_talk_3");
        Talk.Instance.AddTalkDialog(pos1, "sim_turn_c_talk_4");
        ...
        AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_4" }, "ToSideInBed", "90_80", 0.0f, false, 60);
        ...
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_0_4" }, "ToSideInBed", "90_80", 0.0f, false, 50, -1.0f, 2.0f);
        ...
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_4" }, "ToSideInBed", "90_80", 0.0f, false, 50);
        ...
        AnimateSlideMat2.Instance.AddAnimation(new string[] { "HUD_SlideMat2(Clone)#1" }, "PlaceSlideMat1", "500_40", 0.6f, false, 10, 1.0f, 0.1f);
        ...
        AnimateDrawSheet2.Instance.AddAnimation(new string[] { "Talk_0_4" }, "ToSideInBed", "90_80", 0.0f, false, 50);
