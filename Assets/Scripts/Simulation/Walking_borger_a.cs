...
public class Walking_borger_a : MonoBehaviour 
{	
    ...
    private void defineExercise()
    {
        ...
        // Help text
        Help.Instance.AddHelpText(new string[] { "start" }, "sim_walk_a_help_walk_forward");

        // Dialog
        Talk.Instance.AddTalkDialog("hoover_head", "sim_walk_a_talk_walk_forward");
        
        // Animations Female Helper
        AnimateFemale.Instance.SetIdle("200_10");

        // Animations Borger
        AnimateBorger.Instance.SetIdle("190_5");
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_0" }, "Walking", "190_10", 0.0f, false, 10);
    }
