...
public class Remove_sling_in_chair_single : MonoBehaviour 
{	
    ...
    private void defineExercise()
    {
        ...
        AnimateFemale.Instance.SetIdle("1140_10");
        AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_0" }, "PullStrops", "1140_20", 0.0f, false, 10);
        AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_1" }, "LeanForward", "1140_30", 0.0f, false, 20);
		AnimateFemale.Instance.AddAnimation(new string[] { "Talk_0_2" }, "LeanBack", "1140_50", 0.0f, false, 30);
		
         // AnimateSling
        AnimateSling2.Instance.SetIdle("550_10");
        AnimateSling2.Instance.AddAnimation(new string[] { "Talk_0_0" }, "PullStrops", "1140_20", 0.0f, false, 10);
		AnimateSling2.Instance.AddAnimation(new string[] { "RoofLiftUp" }, "LiftUp", "1140_40", 0.0f, false, 20);

        // Animations Borger
        AnimateBorger.Instance.SetIdle("550_10");
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_1" }, "LeanForward", "1140_30", 0.0f, false, 10);
		...
		AnimateRoofLift.Instance.AddAnimation(new string[] { "RoofLiftUp" }, "LiftUp", "1140_40", 0.0f, false, 10);
    }
