...
public class Lie_down_borger_c : MonoBehaviour 
{	
	private void initializeExercise()
	{
		...
		Util.ToggleResource<HUD>("HUD_SlideMat");
	}

    private void defineExercise()
    {
        // Exercise States
        States.Instance.InitExerciseState(new string[] { "BedHeadUp" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_lie_down_c_state_0"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_lie_down_c_state_1"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "hoover_sengegaerde" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_lie_down_c_state_2"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "HUD_SlideMat2(Clone)#3" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_lie_down_c_state_3"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "HUD_Bedsheet2(Clone)#0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_lie_down_c_state_4"), 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_1_0" }, States.CheckCon.NotCritical, "", 8.0f);
        
        // Help text
        Help.Instance.AddHelpText(new string[] { "start" }, "sim_lie_down_c_help_0");
        Help.Instance.AddHelpText(new string[] { "ToolboxDone" }, "sim_lie_down_c_help_1");
        Help.Instance.AddHelpText(new string[] { "BedHeadUp" }, "sim_lie_down_c_help_2");
        Help.Instance.AddHelpText(new string[] { "Talk_0_0" }, "sim_lie_down_c_help_3");
        Help.Instance.AddHelpText(new string[] { "hoover_sengegaerde" }, "sim_lie_down_c_help_4");
        Help.Instance.AddHelpText(new string[] { "HUD_SlideMat2(Clone)#3" }, "sim_lie_down_c_help_5");
        Help.Instance.AddHelpText(new string[] { "HUD_Bedsheet2(Clone)#0" }, "sim_lie_down_c_help_6");
		
        // Dialog
        int pos1 = Talk.Instance.AddTalkDialog("hoover_head", "sim_lie_down_c_talk_0");
        int pos2 = Talk.Instance.AddTalkDialog("clickedHelper", "sim_lie_down_c_talk_1");
		...
		AnimateFemale.Instance.AddAnimation(new string[] { "Talk_1_0" }, "pull", "Bedsheet_01_294f", 0.0f, false, 20);

        // Animations Borger
        AnimateBorger.Instance.SetIdle("150_10");
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_0" }, "Lean in", "150_30", 0.0f, false, 10);
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_1_0" }, "pull", "Bedsheet_01_294f", 0.0f, false, 20);

        // Animate Male
        AnimateMale.Instance.SetIdle("150_10");
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_0_0" }, "HelpSupport", "150_30", 0.0f, false, 10);
        AnimateMale.Instance.AddAnimation(new string[] { "Talk_1_0" }, "Pull", "150_70", 0.0f, false, 20);
        AnimateMale.Instance.AddResetState(new string[] { "HUD_Helper(Clone)#1" });
        ...
        AnimateBed3.Instance.AddAnimation(new string[] { "Talk_1_0" }, "head_end_pos_high_70_degree", 0.0f, 6.0f);

		// Animate Drawsheet
		AnimateDrawSheet2.Instance.SetIdle("lie_down_C_idle");
		AnimateDrawSheet2.Instance.AddAnimation(new string[] { "Talk_1_0" }, "pull", "bedsheet_pull_294f", 0.0f, false, 10);
