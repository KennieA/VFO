...
public class Sit_up_borger_a : MonoBehaviour 
{	
    ...
    {
        // Exercise States
        States.Instance.InitExerciseState(new string[] { "Talk_0_0" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_sit_a_state_bend"), "", 0.0f, 0);
        States.Instance.InitExerciseState(new string[] { "Talk_0_1" }, States.CheckCon.NotCritical, Text.Instance.GetString("sim_sit_a_state_arms"), "", 0.0f);
        States.Instance.InitExerciseState(new string[] { "Talk_0_2" }, States.CheckCon.NotCritical, "", 6.0f);

        // Help text
        Help.Instance.AddHelpText(new string[] { "start" }, "sim_sit_a_help_bend");
        Help.Instance.AddHelpText(new string[] { "Talk_0_0" }, "sim_sit_a_help_arms");
        Help.Instance.AddHelpText(new string[] { "Talk_0_1" }, "sim_sit_a_help_situp");

        // Dialog
        int pos1 = Talk.Instance.AddTalkDialog("hoover_head", "sim_sit_a_talk_bend");
        Talk.Instance.AddTalkDialog(pos1, "sim_sit_a_talk_arms");
        Talk.Instance.AddTalkDialog(pos1, "sim_sit_a_talk_situp");
        ...
        AnimateBorger.Instance.AddAnimation(new string[] { "Talk_0_2" }, "3", "A_bed_Lying_to_Sitting_154f", 0.0f, false, 30);
