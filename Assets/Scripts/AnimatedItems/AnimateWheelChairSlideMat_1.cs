...
public class AnimateWheelChairSlideMat_1 : MonoBehaviour
{
    public class CAnimate
    {
        ...
        {
            s = AnimateWheelChairSlideMat_1.Instance.GetComponent<Animation>()[animName];
        ...
        public void StartAnim()
        {
            ...
            {
                AnimateWheelChairSlideMat_1.Instance.GetComponent<Animation>().CrossFade(s.name, animFadeTime);
            }
        }
    ...
    private static AnimateWheelChairSlideMat_1 _instance;
    public static AnimateWheelChairSlideMat_1 Instance
    {
        get
        {
            if (!_instance)
            {
                _instance = (AnimateWheelChairSlideMat_1)GameObject.FindObjectOfType(typeof(AnimateWheelChairSlideMat_1));

                if (!_instance)
                {
                    Debug.LogError("AnimateWheelChairSlideMat_1 instance could not be found, make sure to add a bed to the scene, and add the AnimateWheelChairSlideMat_1 script to it");
                }
            }
