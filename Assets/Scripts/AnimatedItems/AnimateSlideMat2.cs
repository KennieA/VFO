...
public class AnimateSlideMat2 : MonoBehaviour
{
    public class CAnimate
    {
        ...
        {
            s = AnimateSlideMat2.Instance.GetComponent<Animation>()[animName];
        ...
        public void StartAnim()
        {
            ...
            {
                AnimateSlideMat2.Instance.GetComponent<Animation>().CrossFade(s.name, animFadeTime);
            }
        }
    ...
    private static AnimateSlideMat2 _instance;
    public static AnimateSlideMat2 Instance
    {
        get
        {
            if (!_instance)
            {
                _instance = (AnimateSlideMat2)GameObject.FindObjectOfType(typeof(AnimateSlideMat2));
