...
public class AnimateWheelChairSlideMat_2 : MonoBehaviour
{
    public class CAnimate
    {
        ...
        {
            s = AnimateWheelChairSlideMat_2.Instance.GetComponent<Animation>()[animName];
        ...
        public void StartAnim()
        {
            ...
            {
                AnimateWheelChairSlideMat_2.Instance.GetComponent<Animation>().CrossFade(s.name, animFadeTime);
            }
        }
    ...
    private static AnimateWheelChairSlideMat_2 _instance;
    public static AnimateWheelChairSlideMat_2 Instance
    {
        get
        {
            if (!_instance)
            {
                _instance = (AnimateWheelChairSlideMat_2)GameObject.FindObjectOfType(typeof(AnimateWheelChairSlideMat_2));

                if (!_instance)
                {
                    Debug.LogError("AnimateWheelChairSlideMat_2 instance could not be found, make sure to add a bed to the scene, and add the AnimateWheelChairSlideMat_2 script to it");
                }
            }
