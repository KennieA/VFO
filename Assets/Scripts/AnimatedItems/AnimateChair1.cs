...
public class AnimateChair1 : MonoBehaviour
{
    public class CAnimate
    {
        ...
        {
            s = AnimateChair1.Instance.GetComponent<Animation>()[animName];
        ...
        public void StartAnim()
        {
            ...
            {
                AnimateChair1.Instance.GetComponent<Animation>().CrossFade(s.name, animFadeTime);
            }
        }
    ...
    private static AnimateChair1 _instance;
    public static AnimateChair1 Instance
    {
        get
        {
            if (!_instance)
            {
                _instance = (AnimateChair1)GameObject.FindObjectOfType(typeof(AnimateChair1));

                if (!_instance)
                {
                    Debug.LogError("AnimateChair1 instance could not be found, make sure to add a bed to the scene, and add the AnimateChair1 script to it");
                }
            }
