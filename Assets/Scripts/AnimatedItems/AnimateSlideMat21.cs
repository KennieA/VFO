...
public class AnimateSlideMat21 : MonoBehaviour
{
    public class CAnimate
    {
        ...
        {
            s = AnimateSlideMat21.Instance.GetComponent<Animation>()[animName];
        ...
        public void StartAnim()
        {
            ...
            {
                AnimateSlideMat21.Instance.GetComponent<Animation>().CrossFade(s.name, animFadeTime);
            }
        }
    ...
    private static AnimateSlideMat21 _instance;
    public static AnimateSlideMat21 Instance
    {
        get
        {
            if (!_instance)
            {
                _instance = (AnimateSlideMat21)GameObject.FindObjectOfType(typeof(AnimateSlideMat21));

                if (!_instance)
                {
                    Debug.LogError("AnimateSlideMat2 instance could not be found, make sure to add a bed to the scene, and add the AnimateSlideMat2 script to it");
                }
            }
