...
public class AnimateDrawSheet2 : MonoBehaviour
{
    public class CAnimate
    {
        ...
        {
            s = AnimateDrawSheet2.Instance.GetComponent<Animation>()[animName];
        ...
        public void StartAnim()
        {
            ...
            {
                AnimateDrawSheet2.Instance.GetComponent<Animation>().CrossFade(s.name, animFadeTime);
            }
        }
    ...
    private static AnimateDrawSheet2 _instance;
    public static AnimateDrawSheet2 Instance
    {
        get
        {
            if (!_instance)
            {
                _instance = (AnimateDrawSheet2)GameObject.FindObjectOfType(typeof(AnimateDrawSheet2));

                if (!_instance)
                {
                    Debug.LogError("AnimateDrawSheet2 instance could not be found, make sure to add a bed to the scene, and add the AnimateDrawSheet2 script to it");
                }
            }
