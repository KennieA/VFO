...
public class AnimatePillow : MonoBehaviour
{
    public class CAnimate
    {
        ...
        {
            s = AnimatePillow.Instance.GetComponent<Animation>()[animName];
        ...
        public void StartAnim()
        {
            ...
            {
                AnimatePillow.Instance.GetComponent<Animation>().CrossFade(s.name, animFadeTime);
            }
        }
    ...
    private static AnimatePillow _instance;
    public static AnimatePillow Instance
    {
        get
        {
            if (!_instance)
            {
                _instance = (AnimatePillow)GameObject.FindObjectOfType(typeof(AnimatePillow));

                if (!_instance)
                {
                    Debug.LogError("AnimatePillow instance could not be found, make sure to add a bed to the scene, and add the AnimatePillow script to it");
                }
            }
