...
public class AnimateMale : MonoBehaviour
{
    public class CAnimate
    {
        ...
        {
            s = AnimateMale.Instance.GetComponent<Animation>()[animName];
        ...
        public void StartAnim()
        {
            ...
            {
                AnimateMale.Instance.GetComponent<Animation>().CrossFade(s.name, animFadeTime);
            }
        }
    ...
    private static AnimateMale _instance;
    public static AnimateMale Instance
    {
        get
        {
            if (!_instance)
            {
                _instance = (AnimateMale)GameObject.FindObjectOfType(typeof(AnimateMale));

                if (!_instance)
                {
                    Debug.LogError("AnimateMale instance could not be found, make sure to add a bed to the scene, and add the AnimateMale script to it");
                }
            }
